...
map.getView().fit([-3687221.005892, 4194671.868982, 2010963.508750, 6647008.247302], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Demonstration Webinaire du 27/12/2025</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (221 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = '<marquee>Demonstration des possibilites de Qgis2web. </marquee><br /><br /><img src="https://img.freepik.com/vecteurs-libre/grille-du-globe-terrestre_78370-7981.jpg?semt=ais_hybrid&w=740&q=80" alt="Image" height="100" width="130"><br />';
            }
